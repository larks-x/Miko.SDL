...
/// by default to SDLK_0...SDLK_9 on AZERTY layouts.<br/>
/// Keys with the `SDLK_EXTENDED_MASK` bit set do not map to a scancode or<br/>
/// Unicode code point.<br/>
/// Many common keycodes are listed below, but this list is not exhaustive.<br/>
/// <br/>
/// @since This datatype is available since SDL 3.2.0.<br/>
/// <br/>
...
/// pen's digitizer table is physically detached from the computer, it might<br/>
/// get a new ID when reconnected, as SDL won't know it's the same device.<br/>
/// These IDs are only stable within a single run of a program; the next time a<br/>
/// program is run, the pen's ID will likely be different, even if the hardware<br/>
/// hasn't been disconnected, etc.<br/>
/// <br/>
/// @since This datatype is available since SDL 3.2.0.
/// </summary>
...
/// <summary>
/// An ID that represents a properties set.<br/>
/// <br/>
/// @since This datatype is available since SDL 3.2.0.
/// </summary>
...
/// <summary>
/// A custom GPU render state.<br/>
/// <br/>
/// @since This struct is available since SDL 3.4.0.<br/>
/// <br/>
/// @sa SDL_CreateGPURenderState<br/>
/// @sa SDL_SetGPURenderStateFragmentUniforms<br/>
/// @sa SDL_SetGPURenderState<br/>
/// @sa SDL_DestroyGPURenderState
/// </summary>
[DebuggerDisplay("{DebuggerDisplay,nq}")]
public readonly partial struct SDL_GPURenderState(nint value) : IEquatable<SDL_GPURenderState>
{
	public readonly nint Value = value;
	public bool IsNull => Value == 0;
	public bool IsNotNull => Value != 0;
	public static SDL_GPURenderState Null => new(0);
	public static implicit operator nint(SDL_GPURenderState value) => value.Value;
	public static implicit operator SDL_GPURenderState(nint value) => new(value);
	public static bool operator ==(SDL_GPURenderState left, SDL_GPURenderState right) => left.Value == right.Value;
	public static bool operator !=(SDL_GPURenderState left, SDL_GPURenderState right) => left.Value != right.Value;
	public static bool operator ==(SDL_GPURenderState left, nint right) => left.Value == right;
	public static bool operator !=(SDL_GPURenderState left, nint right) => left.Value != right;
	public bool Equals(SDL_GPURenderState other) => Value.Equals(other.Value);
	/// <inheritdoc/>
	public override bool Equals([NotNullWhen(true)] object? obj) => (obj is SDL_GPURenderState other) && Equals(other);
	/// <inheritdoc/>
	public override int GetHashCode() => Value.GetHashCode();
	private string DebuggerDisplay => $"{nameof(SDL_GPURenderState)} [0x{Value.ToString("X")}]";
}
